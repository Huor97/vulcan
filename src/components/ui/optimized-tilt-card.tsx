...
export const OptimizedTiltCard: React.FC<TiltCardProps> = ({
  ...
  return (
    <div
      ...
      className={`relative overflow-visible group touch-manipulation ${className}`}
      style={cardStyle}
    >
      {children}
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at var(--pointer-x) var(--pointer-y), rgba(255,255,255,0.15) 0%, transparent 80%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle 90px at var(--pointer-x) var(--pointer-y), rgba(255,255,255,0.05), transparent 70%)",
        }}
      />
    </div>
  );
